...
@author: Arpit
"""
print("Lidar and Ultrasound sensors data analysis and parameters when the signal is being reflected from a soft surface:\n")
import csv
import numpy as np
...
Reading data 
"""
with open('Midterm_F17_LIDAR_Ultrasound_100ms_1m_000_soft.csv', 'r') as f:
    reader = csv.reader(f)
    your_list = list(reader)

with open('Midterm_F17_LIDAR_Ultrasound_100ms_2m_000_soft.csv', 'r') as f:
    reader = csv.reader(f)
